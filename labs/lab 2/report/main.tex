...
\begin{enumerate}[1)]
    \item Open the application using the command `python3 lab.py`
\end{enumerate}

\subsection*{Output}

\adjincludegraphics[width=1\textwidth]{a.png}

\section*{Part B}

\subsection*{Procedure}
\begin{enumerate}[1)]
    \item From Part A press any key to start part b
    \item Adjust the threshold sliders, the images will automatically update
    \item Press `ESC` key to quit application
    \item When the application exits the resulting threshold images will be saved in the `results` directory.
\end{enumerate}

\subsection*{Output}

\adjincludegraphics[width=1\textwidth]{b.png}
