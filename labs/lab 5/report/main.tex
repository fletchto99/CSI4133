...
\newcommand{\assignemntNumber}{5}
\newcommand{\dueDate}{Nov. 9, 2017}
...
\begin{enumerate}[1)]
    \item Open the application using the command \code{python3 lab5a.py}
    \item The image will highlight all of the circles found
\end{enumerate}

\subsection*{Output}

Here is a screenshot of the output on circles\_target.jpg:

\adjincludegraphics[width=0.8\textwidth]{circles.png}
...
\subsection*{Procedure}
\begin{enumerate}[1)]
    \item Open the application using the command \code{python3 lab5b.py}
    \item The image will display all of the edge's lines. Unfortunately I was unable to get intersection detection working
\end{enumerate}

\subsection*{Output}

Here is a screenshot of the output on lines\_target.jpg:

\adjincludegraphics[width=0.8\textwidth]{lines.png}
